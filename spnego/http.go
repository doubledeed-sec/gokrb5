...
const (
	...
	CTXKeyAuthenticated ctxKey = "github.com/doubledeed-sec/gokrb5/CTXKeyAuthenticated"
	// CTXKeyCredentials is the request context key holding the credentials gopkg.in/jcmturner/goidentity.v2/Identity object.
	CTXKeyCredentials ctxKey = "github.com/doubledeed-sec/gokrb5/CTXKeyCredentials"
